...
| start | Runs lints, starts dev webserver, and opens the app in your default browser. |
| start-test | Runs tests, lints, starts dev webserver, and opens the app in your default browser. |
...
### Why are test files placed alongside the file under test (instead of centralized)? (It doesn't apply yet)
